...
@Component({
    ...
    styleUrls: ['../customs-select.scss', './profile-select.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations,
})
export class ProfileSelectComponent extends BaseSelectComponent<any> {
    _disabled = false;
    ...
    pesquisaFn(filtro: any): Observable<State[]> {
        ...
        return this._service.profileFindAll({
            where: whereObj,
            offset: 0,
            order: [['descricao', 'asc']],
            limit: 30,
