...
@Component({
    ...
    styleUrls: ['../customs-select.scss', './services-select.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations,
})
export class ServiceSelectComponent extends BaseSelectComponent<any> {
    _disabled = false;
    ...
    pesquisaFn(filtro: any): Observable<State[]> {
        ...
        return this._service.serviceFindAll({
            where: whereObj,
            offset: 0,
            order: [['descricao', 'asc']],
            limit: 30,
